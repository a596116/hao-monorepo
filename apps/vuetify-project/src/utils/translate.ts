...
translate.vue3.config = function (app) {
  ...
  window.translate.selectLanguageTag.languages = "chinese_traditional,chinese_simplified,english,korean,japanese"

  // 设置本地语种（当前网页的语种） ，如果你网页语种很多，比如国际化论坛，哪个国家发言的都有，那这里你可以不用设置，交给 translate.js 自动去识别当前网页语种 http://translate.zvo.cn/4066.html
  window.translate.language.setLocal("chinese_traditional")
